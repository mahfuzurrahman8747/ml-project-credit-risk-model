...
def prepare_input(age, income, loan_amount, loan_tenure_months, avg_dpd_per_delinquency,
                    delinquency_retio, credit_utilization_ratio, num_open_accounts, residence_type,
    ...
    input_data = {
        ...
        'delinquency_retio': delinquency_retio,
...
def predict(age, income, loan_amount, loan_tenure_months, avg_dpd_per_delinquency,
            delinquency_retio, credit_utilization_ratio, num_open_accounts,
